      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {popularBooks.map((book) => (
          <motion.div
            ...
            className=" bg-white rounded-3xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col h-full"
          >
            {/* Image Section */}
            <div className="w-full h-[150px] bg-gray-50 flex items-center justify-center px-6">
              <img
            ...
            <div className="p-6 flex flex-col flex-grow">
              <div className="space-y-3 flex-grow">
                <h3 className="w-full text-md font-semibold text-gray-800">
                  {book.book_title}
                </h3>
              ...
              {/* Footer Section - always bottom */}
              <div className="flex justify-between items-center pt-4 border-t border-gray-200 mt-4">
                <span className="text-sm font-medium text-purple-600 bg-purple-100 px-2 py-1 rounded-full">
                  {book.upvote} upvotes{" "}
                  <BiSolidUpvote className="inline-block mb-1" />
                </span>
